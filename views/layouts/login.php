...
<head>
    ...
    <!-- //For-Mobile-Apps -->
    <!-- Style --> <link rel="stylesheet" href="<?=Yii::$app->homeUrl?>css/style.css" type="text/css" media="all" />
</head>
<body>
<div class="container">
<!--    <h1>Control.uz</h1>-->
...
<!--</div>-->
<div class="footer">
    <p>Ushbu dastur <a href="http://ubtuit.uz">TATU Urganch filiali</a> talabasi tomoidan yaratilgan </p>
</div>
